var BackgroundLayer = cc.Layer.extend({
    ...
    ctor:function (space) {
        ...
        this.map00 = cc.TMXTiledMap.create(res.s_map00);
        this.addChild(this.map00);

        this.mapWidth = this.map00.getContentSize().width;

        this.map01 = cc.TMXTiledMap.create(res.s_map01);
        this.map01.setPosition(cc.p(this.mapWidth, 0));
        this.addChild(this.map01);

        // create sprite sheet
        cc.spriteFrameCache.addSpriteFrames(res.s_backgroundplist);
        this.spriteSheet = cc.SpriteBatchNode.create(res.s_background);
